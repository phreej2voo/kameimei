                    ...
                    _createClass(PhotoClip, [{
                        ...
                        value: function _initRotationEvent() {
                            ...
                            if (is_mobile) {
                                ...
                                var startTouch = void 0,
                                    startAngle = void 0,
                                    curAngle = void 0;

                                this._hammerManager.on('rotatestart', function (e) {
                                    if (_this2._atRotation) return;
                                    startTouch = true;

                                    if (rotateFree) {
                                        startAngle = (e.rotation - _this2._curAngle) % 360;
                                        _this2._rotationLayerRotateReady(e.center);
                                    } else {
                                ...
                                this._hammerManager.on('rotatemove', function (e) {
                                    ...
                                    rotateFree && _this2._rotationLayerRotate(curAngle);
                                });
                                ...
                                this._hammerManager.on('rotateend rotatecancel', function (e) {
                                    ...
                                    if (!rotateFree) {
                                        ...
                                        if (curAngle > 30) {
                                            _this2._rotateBy(90, bounceTime, e.center);
                                        } else if (curAngle < -30) {
                                            _this2._rotateBy(-90, bounceTime, e.center);
                                        }
                                        return;
                                    ...
                                    _this2._rotationLayerRotateFinish(curAngle, bounceTime);
                                });
                            } else {
                        ...
                        value: function _rotationLayerRotateReady(center) {
                            ...
                            var coord = void 0; // 旋转参考点在移动层中的坐标
                        ...
                        value: function _rotationLayerRotateFinish(angle, duration) {
                            ...
                            if (angle !== this._curAngle && duration && (0, _isNumber2.default)(duration) && supportTransition !== undefined) {
                                ...
                                setTransition(this._$rotationLayer, this._rotationLayerX + offset.x, this._rotationLayerY + offset.y, angle, duration, function () {
                                    _this3._atRotation = false;
                                    _this3._rotateFinishUpdataElem(angle);
                                });
                            } else {
                        ...
                        value: function _createImg(src) {
                            ...
                            this._$img.onload = function (e) {
                                var img = e.target;
                                _this6._imgLoaded = true;
                                options.loadComplete.call(_this6, img);
