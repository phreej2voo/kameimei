!function (n) {
    var r = {};
    // var myInstance = new yt();

// 调用 showCardDesc 方法
    // myInstance.handlePan();
    function i(e) {
            ...
            previewStore: new (De = q.d.bound, Re = q.d.bound, Le = q.d.bound, Fe = q.d.bound, Be = q.d.bound, ze = q.d.bound, Ue = q.d.bound, We = q.d.bound, Ve = q.d.bound, Ge = q.d.bound, $e = q.d.bound, He = q.d.bound, qe = q.d.bound, Xe = q.d.bound, Ye = q.d.bound, Ke = q.d.bound, Qe = q.d.bound, Je = q.d.bound, Ze = q.d.bound, et = q.d.bound, tt = q.d.bound, nt = q.d.bound, rt = q.d.bound, it = q.d.bound, ot = q.d.bound, at = q.d.bound, ut = q.d.bound, ct = q.d.bound, st = q.d.bound, lt = q.d.bound, ft = q.d.bound, pt = q.d.bound, ht = q.d.bound, dt = q.d.bound, mt = q.d.bound, vt = q.d.bound, yt = function () {
                ...
                return u()(e, [{
                    ...
                    key: "handlePanStart", value: function (e) {
                        ...
                        8 == e.offsetDirection && (this.sideNum++, this.sideNum == t && (this.sideNum = 0), this.pageTransform = this.pageHeight), 
                        16 == e.offsetDirection && (this.sideNum--, this.sideNum < 0 && (this.sideNum = t - 1), this.pageTransform = -this.pageHeight), 
                    ...
                    key: "handlePan", value: function (e) {
                        ...
                        0 < t ? t -= this.distance : t += this.distance, 
                        $(".main_page").eq(this.sideNum).css("transform", "translate3d(0,".concat(t, "px,0)"))
                        console.log('滑动', this.sceneType, this.sceneType == 2)
                        if (this.sceneType == 2) {
                            $(".z-current").css("transform", "translate3d(0,".concat(t - 376.835, "px,0)"))    
                        }
                    }
            ...
            return p()(o, e), u()(o, [{
                key: "render", value: function () {
                    var e = this, t = this.state, n = t.show_guide, r = t.show_yqh, i = this.props.previewStore,
                        ...
                        v = l.is_show_guide;
                    return H.a.createElement(T.Fragment, null, 1 == s && u && H.a.createElement("header", {className: "loading_page"}, H.a.createElement("div", {className: "cover"}, H.a.createElement("div", {className: "bg"}), H.a.createElement("img", {src: p}))), H.a.createElement("span", {className: "resize_arrow"}), H.a.createElement("span", {className: "page_num"}, o + 1, "/", 1 == f ? a.length + 1 : a.length), 1 == h && H.a.createElement("div", {className: "click_buy"}, !c && H.a.createElement("a", {
                        className: "back",
                    ...
                    }, H.a.createElement("em", null, "[ ", scene.specify_invite.name, " ]"), H.a.createElement("p", null, scene.specify_invite.invite_word), H.a.createElement("span", {className: r ? "shake" : null}, "查看详细")))), H.a.createElement("section", {className: "kmm_progress_bar"}, H.a.createElement("span", {style: {width: "".concat(i.progressBar, "px")}})))
                }
            }]), o
